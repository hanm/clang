...
class [[asap::param("ClassB"),
        asap::base_arg("A", "ClassB:A")]] B : public A {
    int b [[asap::arg("ClassB")]];
public:
      inline void setB [[asap::writes("ClassB")]] (int _b) { b = _b;};
      void set [[asap::writes("ClassB, ClassB:A")]] (int _a, int _b) {
        setA(_a);
        b = _b;
      }
};

class [[asap::param("ClassC"), asap::base_arg("B", "ClassC:B")]] C : public B {
    int c [[asap::arg("ClassC")]];
public:
      inline void setC [[asap::writes("ClassC")]] (int _c)
        { c = _c;};
      void set [[asap::writes("ClassC, ClassC:B, ClassC:B:A")]] (int _a, int _b, int _c) {
        setA(_a);
        setB(_b);
        c = _c;
      }
