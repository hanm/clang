...
class 
__attribute__((region("1R1")))        // invalid
__attribute__((region_param("1P1")))  // invalid
__attribute__((region("R2")))
__attribute__((region("_R2")))
__attribute__((region("R_2")))
__attribute__((region("R_2c_")))
__attribute__((region_param("P_2c_")))
__attribute__((region_param("P1")))
__attribute__((region_param("P2")))
C1 { // expected-warning {{invalid region or parameter name}} expected-warning {{invalid region or parameter name}} 
...
public:
  ...
  void set_money(int cash) __attribute__((writes_effect("P1:R3"))) { // expected-warning {{RPL element was not declared}}  
    money = cash;
  }
  ...
  void subtract_money(int cash) __attribute__((writes_effect("P1:R3"))) { // expected-warning {{RPL element was not declared}}  
    money -= cash;
  }
